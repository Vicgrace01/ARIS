...
| Metric | Value |
|---|---|
| Training corpus | 2448 hand-authored ChatML records (CC BY 4.0) |
...
| Frozen evaluation (tolerant canonical) | 0.0% weighted |
| Wording penalty of strict rubric | +-81.0 points recovered under canonicalization |
...
tolerant-canonical figure alongside it. The -81.0-point gap measures how
...
a 2448-record corpus causes catastrophic forgetting — the model loses
...
- **Training datasets:** `ARIS_V10_FINAL_DATASET_V5.jsonl` — 2448 ChatML
...
- `adapter/adapter_manifest.json` — SHA-256, size, and HuggingFace URL for
  ...
  295 MB) are hosted at `https://huggingface.co/Vicgrace/ARIS-V10.1` because the file exceeds GitHub's
  100 MB per-file limit. The manifest records the exact revision
  (`894c24fb6c4143acda0b3e54e26ef44b962e67a5`) and the SHA-256
  (`b5500b5603e79d055eb1baafc9d1cf4c234c2378cba9d8478ea4de974a677832`). Verification is a two-command operation documented
...
The training corpus for ARIS V10.1 contains 2448 records. Every
...
| Frozen evaluation (tolerant canonical) | 0.0% (0/0 weighted) | `frozen_eval_tolerant.json` |
...
score (0.0%) alongside it. Every rescued record — a
